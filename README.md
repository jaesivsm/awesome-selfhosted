...
### Custom
  ...
  * [Actor](https://actor.im/) - Actor is an open source fast open source messaging platform with rich mobile and web clients. ([Demo](https://app.actor.im), [Source Code](https://github.com/actorapp/actor-platform)) `AGPLv3` `Scala`
...
### Social Networks and Forums
  ...
  * [Abilian SBE](https://github.com/abilian/abilian-sbe) - Open Source Collaboration and Social Networking framework & platform. `LGPL` `Python`
...
## Feed Readers
  ...
  * [JARR](https://github.com/jaesivsm/JARR) - JARR is a web based feed agregator and reader with a one page UI running on ReactJS.. ([Demo](https://jarr.info/)) `AGPL-3.0` `Python3`
...
## Groupware
  ...
  * [Kolab](https://kolab.org/) - Kolab community is a unified communication and collaboration system. ([Source Code](https://git.kolab.org/)) `Various FLOSS Licenses` `C++/Python/PHP`
...
### Audio Streaming
  ...
  * [Icecast 2](http://www.icecast.org/) - streaming audio server which can be used to create an Internet radio station or a privately running jukebox and many things in between. ([Source Code](https://git.xiph.org/?p=icecast-server.git;a=summary)) `GPLv2` `C`
...
## Self-hosting Solutions
  ...
  * [DPlatform](https://j8r.github.io/DPlatform/) - Deploy self-hosted apps easily: simple, bloat-free, independent installation. ([Source code](https://github.com/j8r/DPlatform)) `MIT` `Shell`
